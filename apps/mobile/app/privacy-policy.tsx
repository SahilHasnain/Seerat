                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "32px" }}>
                    <section>
                        ...
                        <p style={{ fontSize: "16px", color: "#374151", lineHeight: "1.75" }}>
                            Welcome to Seerat. We respect your privacy and are committed to protecting your personal data.
                    ...
                    <section>
                        ...
                        <p style={{ fontSize: "16px", color: "#374151", lineHeight: "1.75", marginBottom: "8px" }}>
                            Seerat is designed with privacy in mind. We collect minimal information:
                        </p>
                    ...
                    <section>
                        ...
                        <p style={{ fontSize: "16px", color: "#374151", lineHeight: "1.75" }}>
                            All your personal data, including playback history, preferences, and downloaded content,
                            are stored locally on your device. We do not transmit or store this information on external servers.
                        </p>
                    </section>
